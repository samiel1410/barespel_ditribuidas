                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody class="table-success">
                            ...
                            <tr>
                                <td>
                                    <p class="card-text">{{$menu->bar->campus->nombre}} </p>
                                </td>

                                <td>
                                    <p class="card-text">{{$menu->nombre}}</p>
                                </td>
                                <td>
                        ...
                        <table class="table">
                            ...
                            <tbody class="table-success">
                                <h1>Bar 2</h1>
                                @foreach($menus as $menu)
                                @if($menu->bar->nombre == "Bar 2" and $menu->disponible == "1" )
                                <tr>
                                    <td>
                                        <p class="card-text">{{$menu->bar->campus->nombre}} </p>
                                    </td>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-success">
                            ...
                            @if($count< 4 and $snack->disponible == "1")
                                ...
                                <tr>
                                    <td>
                                        <p class="card-text">{{$snack->bar->campus->nombre}} </p>
                                    </td>
                                    <td>
                                        <p class="card-text">{{$snack->bar->nombre}} </p>
                                    </td>
                                    <td>
                                        <p class="card-text">{{$snack->nombre}} </p>
                                    </td>
                                    <td>
                                        <p class="card-text">{{$snack->precio}}$</p>
                                    </td>
                                    <br>
                                </tr>
                                @endif
