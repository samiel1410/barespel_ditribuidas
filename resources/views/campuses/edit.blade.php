            ...
            <form action="{{route('campuses.update',['campus'=>$campus->id])}}" method="POST" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control String" type="text" name="nombre" id="nombre"
                        value="{{old('nombre',$campus->nombre)}}" required="required">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control String" type="text" name="direccion" id="direccion"
                        value="{{old('direccion',$campus->direccion)}}" required="required">
